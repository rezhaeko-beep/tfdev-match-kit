# Prompt Analitik — TFDEV Analitik
...
2. **Overall score 0–100** + label (`EXCELLENT|GOOD|DEVELOPING|NEEDS FOCUS`) — harus bisa dijelaskan dari observasi
3. **Session summary:** 2–3 kalimat untuk orang tua (positif, konkret, tanpa jargon berat)
...
5. **Strengths:** 3–5 poin konkret
6. **Focus areas:** maks 3, actionable
7. **Home drills:** 4 drill, 10–15 menit, 2–3×/minggu, tiap drill punya goal
8. **Coach note:** 1 paragraf hangat + signature name (default Coach Pramu jika tidak disebut)

## Aturan kualitas
- **Honesty first / video-first:** bukti utama adalah VIDEO/frames; lebih baik `null` / N/C daripada angka palsu
